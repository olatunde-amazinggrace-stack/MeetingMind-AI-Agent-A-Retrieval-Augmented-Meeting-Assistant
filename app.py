        ...
        if not gemini_api_key:
            ...
            def ask_document(question):
                retriever = st.session_state.vectorstore.as_retriever(
                    search_kwargs={"k": 5} # Increased k to retrieve more chunks for potentially varied context
                )
...
"""
                ...
                # Assuming response.content is a list of parts, each with a 'text' field, as seen in user's previous output.
