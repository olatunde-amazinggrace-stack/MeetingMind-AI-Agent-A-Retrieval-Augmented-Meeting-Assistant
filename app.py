...
gemini_api_key = st.sidebar.text_input("Enter your Google Gemini API Key", type="password", key="gemini_api_key_input")

# Model selection (using the available models from STO5N66RUgV_ output, filtering for chat models)
CHAT_MODELS = [
    "gemini-3.5-flash",
    "gemini-2.5-flash",
    "gemini-2.5-pro"
    # Add other chat models if desired from the client.models.list() output
]
selected_model = st.sidebar.selectbox("Select Gemini Model", CHAT_MODELS)
