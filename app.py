...
from langchain_community.embeddings import SentenceTransformerEmbeddings # Changed from HuggingFaceEmbeddings
...
@st.cache_resource
def load_embeddings():
    # Using SentenceTransformerEmbeddings for direct model loading, avoiding hf_token validation issues.
    # This model does not require an explicit HF_TOKEN in its constructor or implicitly via environment
    # for basic usage (downloading and using the model).
...
if not st.session_state.authenticated:
    ...
    with st.container(border=True):
        ...
        if uploaded_file is not None:
            ...
            with st.spinner("Embedding chunks and creating vector store (this may take a moment)..."):n                embeddings = load_embeddings()
