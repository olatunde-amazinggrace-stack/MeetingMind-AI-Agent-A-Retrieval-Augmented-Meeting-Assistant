...
st.set_page_config(
    ...
    layout="wide", # Reverted to 'wide' as it was initially and might be preferred
...
def show_auth_page():
    ...
    # Removed default_index from st.tabs() for compatibility
        ...
        if st.button("Register"):
            if new_password != confirm_password:
                ...
                if register_user(new_username, new_password):
                    ...
                    # No automatic tab switch, user will manually go to Login
                else:
